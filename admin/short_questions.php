...
?>
	...
	<br>
<h1 align="center" style="color:white;" >Short Detailed ( Questions )</h1>
  <br>
...
<!---------------------------------------------------Section 3--------------------------------------------------------------->
   ...
   */
   ...
   f.q_p_formate_id, f.q_paper_id, p.q_paper_id, p.user_name FROM mcq m, q_p_formate f, q_paper p
    WHERE f. ";
	*/
	$query_b="SELECT a.short_q_id, a.short_q_detail, a.short_q_marks,
	a.q_p_formate_id, a.status, b.q_p_formate_id, b.q_paper_id
	FROM short_q a , q_p_formate b WHERE a.q_p_formate_id=b.q_p_formate_id";
 ...
 while($row_b=mysqli_fetch_array($result_b))
  ...
  <tr align="center">
             <td align="center">    <?php echo $row_b["q_paper_id"];       ?>        </td>
              <td>                   <?php echo $row_b["short_q_id"];      ?>        </td>
			 <td align="left">      <?php echo $row_b["short_q_detail"];     ?>        </td>
             
			 <td>                   <?php echo $row_b["short_q_marks"];      ?>        </td>
