...
?>
	...
	<br>
<h1 align="center" style="color:white;" >Long Detailed ( Questions )</h1>
  <br>
...
<!---------------------------------------------------Section 3--------------------------------------------------------------->
   ...
   */
   ...
   f.q_p_formate_id, f.q_paper_id, p.q_paper_id, p.user_name FROM mcq m, q_p_formate f, q_paper p
    WHERE f. ";
	*/
	$query_b="SELECT a.long_q_id, a.long_q_detail, a.long_q_marks,
	a.q_p_formate_id, a.status, b.q_p_formate_id, b.q_paper_id
	FROM long_q a , q_p_formate b WHERE a.q_p_formate_id=b.q_p_formate_id";
...
<?php
 while($row_b=mysqli_fetch_array($result_b))
  ...
  <tr align="center">
             ...
             <td align="left">      <?php echo $row_b["long_q_detail"];     ?>        </td>
             <td>                   <?php echo $row_b["long_q_marks"];      ?>        </td>
			 <td>                   <?php echo $row_b["long_q_id"];      ?>        </td>
