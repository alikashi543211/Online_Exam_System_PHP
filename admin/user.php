...
?>
	...
	<br>
<h1 align="center" style="color:white;" >User Information</h1>
  <br>
 ...
 while($row_b=mysqli_fetch_array($result_b))
  {
	 ?>
  <tr align="center">
             <td align="center">    <?php echo $row_b["user_id"];       ?>        </td>
             <td align="left">      <?php echo $row_b["user_name"];     ?>        </td>
             <td align="left">      <?php echo $row_b["password"];      ?>        </td>
             <td align="center">    <?php echo $row_b["contact_no"];    ?>        </td>
