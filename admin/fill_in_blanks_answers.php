...
?>
	...
	<br>
<h1 align="center" style="color:white;" >Fill in Blanks ( Answers )</h1>
  <br>
...
<!---------------------------------------------------Section 3--------------------------------------------------------------->
   ...
   */
   ...
   f.q_p_formate_id, f.q_paper_id, p.q_paper_id, p.user_name FROM mcq m, q_p_formate f, q_paper p
    WHERE f. ";
	*/
	$query_b="SELECT  a.option_name, a.ans, a.question_id, a.status ,
	b.q_paper_id, b.question_id, b.question, p.q_paper_id FROM fb_answers a, fb_questions b, q_paper p 
	WHERE (a.question_id=b.question_id && b.q_paper_id=p.q_paper_id) ";
...
<?php
 while($row_b=mysqli_fetch_array($result_b))
  ...
  <tr align="center">
             ...
             <td align="center">      <?php echo $row_b["option_name"];      ?>        </td>
             <td align="center">    <?php echo $row_b["ans"];    ?>        </td>
