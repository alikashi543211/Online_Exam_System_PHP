...
<h1 align="center" style="color:green;">Set Answers of '<?php echo " ".$obj_type; ?>'</h1>
...
?>	
 ...
 <tr>
   <td colspan="2" align="center"><input style="cursor:pointer;width:100px;height:50px;" type="submit" name="<?php echo $button; ?>" value="<?php echo $button; ?>" /></td>
 </tr>
 </table>
</form>
...
<form align="center" method="get">
	...
	<input style="cursor:pointer;width:200px;height:50px;color:black;border-radius:4px;" type="submit" name="<?php echo $btn_name; ?>" value="<?php echo $btn_value; ?>" />
