...
{
include_once "mix_sub_paper_print.php";	
}
...
<td border="5" colspan="2" align="right" class="print_btn2"><a href="complete_mix_paper.php?id1=obj">Edit Objective</a>
	...
	<a href="sub_disp_mode.php">Edit Subjective</a>
				  <?php } else if(isset($_SESSION['short_questions'])) { ?>
				  
	<a href="short_q_paper.php">Edit Subjective</a>
				  <?php } else if(isset($_SESSION['long_questions'])) {  ?>
	<a href="long_q_paper.php">Edit Subjective</a>
				  <?php } ?>
