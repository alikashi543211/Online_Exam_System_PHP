...
//______________________________________Stage of Mix Paper__________________________________________

$_SESSION['finish_check']=0;
if(isset($_SESSION['section2']) && isset($_SESSION['short_questions']) && ($_SESSION['long_questions']))
{
	header ("Location:sq_in_mix_paper.php");
} else
if(isset($_SESSION['section2']) && isset($_SESSION['short_questions']))
{
	header ("Location:short_q_paper.php");
} else
if(isset($_SESSION['section2']) && ($_SESSION['long_questions']))
{
	header ("Location:long_q_paper.php");
}

//______________________________________/Stage of Mix Paper__________________________________________
...
if(isset($_POST['next1']))
	{	
		...
		$result_c=mysqli_query($con,$query_c);
		 ...
		 unset($_SESSION['fb_ready']);
		 unset($_SESSION['tf_ready']);
		 $_SESSION['mcq_ready']="Set Answers of MCQs.";
...
<?php /* <h3 align="center" style="color:navy;">Marks = <?php  echo "(".$num_of_questions."*".$marks_of_each.")"; ?></h3> */ ?>
...
<!--___________________Button_____________________--> 
 ...
 <tr>
  <td align="center">  	
	<br><br><br><input style="border-radius:4px;border:none;cursor:pointer;width:100px;height:50px;background-color:navy;color:white;" type="submit"
...
<form method="post">
	...
	<tr>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;" type="submit" name="disp_mcq" value="Show MCQs (Questions)" /></td>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;" type="submit" name="disp_fb" value="Show Fill in Blanks (Questions)" /></td>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;" type="submit" name="disp_tf" value="Show True False (Questions)" /></td>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;" type="submit" name="edit_ans" value="Edit Answers" /></td>
	...
	<?php } ?>
	<?php if(isset($_SESSION['mix_1']) || isset($_SESSION['mix_11'])) { ?>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;" type="submit" name="mov_to" value="Go To Subjective" /></td>
	<?php } ?>
...
if(isset($_SESSION['mcq_on']) && !isset($_SESSION['edit_update']) && !isset($_SESSION['refresh']))
{
	                      ...
	                      <tr>
	                        ...
	                        <td><input style="padding:5px;border:none;height:30px;width:1050px;" type="text" 
		                       <?php if (isset($edit_id) && $row_d['question_id']==$edit_id) { ?>  <?php }else { ?> readonly <?php } ?> name=""
								...
								<td><a href="mix_obj_questions_paper.php?edit_question_id=<?php echo $row_d['question_id']; ?>">Edit</a></td>
								<td><a href="mix_obj_questions_paper.php?delete_question_id=<?php echo $row_d['question_id']; ?>">Delete</td>
...
if(isset($_SESSION['tf_on']) && !isset($_SESSION['edit_update']) && !isset($_SESSION['refresh']))
{
	echo "<br><h1 style='color:navy;' align='center'>Questions ( <span style='color:red;'>True False</span> )</h1>";
   /*  	
?>
...
if(isset($_SESSION['fb_on'])&& !isset($_SESSION['edit_update']) && !isset($_SESSION['refresh']))
{
echo "<br><h1 style='color:navy;' align='center'>Questions ( <span style='color:red;'>Fill in Blanks</span> )</h1>";
	/*
?>
