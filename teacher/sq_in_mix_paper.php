...
if(isset($_POST['done']) && $calculate_total==$t_marks_sq)
	{
...
<?php
// __________________SHORT QUESTIONS FORMATE_______________________-->
if(isset($_SESSION['short_questions']))
{
	...
	$extra=$_SESSION['quan_sq2'];
	$question_number=1;
}
//   _____________________/SHORT QUESTIONS FORMATE_______________________-->
...
// ------------------------------------------ WHEN CLICK ON SHOW SHORT QUESTIONS ----------------------------------------
	                      ...
	                      <tr>
	                        ...
	                        <td><input style="padding:5px;border:none;height:30px;width:1050px;" type="text" 
                             ...
                             value="<?php { echo $row_d['short_q_detail']; }  ?>"	required /></td>     <?php //Question Discription... ?>
								...
								<td><a href="sq_in_mix_paper.php?edit_question_id=<?php echo $row_d['short_q_id']; ?>">Edit</a></td>
								<td><a href="sq_in_mix_paper.php?delete_question_id=<?php echo $row_d['short_q_id']; ?>">Delete</td>
