 ...
 if(isset($_GET['mcq_ans']))
{
	...
	$_SESSION['update']="Update Session";
	unset($_SESSION['tf_ready']);
	unset($_SESSION['fb_ready']);
...
<?php //if((isset($_SESSION['edit_answers']) || isset($_SESSION['set_btn2']) || isset($_SESSION['return_back']))  && !isset($_SESSION['edit_update']))
if(isset($_SESSION['done']))
	{ ?>

<center><span align="center" style="color:Navy;font-size:40px;">Answers Of Created Paper<br><br></span></center>
<?php } ?>
...
<?php if (isset($_SESSION['edit_update'])) { ?> disabled <?php } ?>	type="submit" name="mcq_ans" value="Show MCQs (Answers)" /></td>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;"
...
<?php if (isset($_SESSION['edit_update'])) { ?> disabled <?php } ?>	type="submit" name="questions" value="Edit Questions" /></td>
	<?php if (isset($_SESSION['2_one'])) {  ?>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;"
<?php if (isset($_SESSION['edit_update'])) { ?> disabled <?php } ?>	type="submit" name="go_sub" value="Go To Subjective" /></td>
	<?php } ?>
	<?php if (isset($_SESSION['two_s']) || isset($_SESSION['double_1'])) {  ?>
	<td><input style="border-radius:4px;border:none;cursor:pointer;width:200px;height:50px;background-color:navy;color:white;"
<?php if (isset($_SESSION['edit_update'])) { ?> disabled <?php } ?>	type="submit" name="go_sub" value="Go To Subjective" /></td>
	<?php } ?>
...
<?php } else if(isset($_SESSION['mcq_ready'])) { 
?>
...
// --------------------------------------------- /Insert Objective Answers Message ---------------------------------------------
 ...
 /* else  if(isset($_SESSION['edit_update']) && !isset($_SESSION['refresh'])) {?>
 <?php if(isset($_SESSION['fb_ready'])) { ?>
<h1 align="center" style="color:navy;">Edit \ Update \ Delete '<?php echo "<span style='color:red;'>Fill in Blanks</span>"; ?>' Answers</h1>

<?php } else if(isset($_SESSION['mcq_ready'])) { 
?>
<h1 align="center" style="color:navy;">Edit \ Update \ Delete '<?php echo "<span style='color:red;'>MCQs</span>"; ?>' Answers</h1>
<?php
 } 
 }
 */ ?>
 ...
 */ ?>
 ...
 <tr>
   ...
   <input style="border-radius:4px;border:none;cursor:pointer;width:100px;height:50px;background-color:navy;color:white;" <?php if(!isset($edit_question_id)) { ?> disabled <?php } ?> type="submit" name="<?php echo "Update"; ?>" value="<?php echo "Update"; ?>" />
...
?>
 <tr style="text-align:center;">
  ...
  <?php if(isset($_SESSION['done'])) { ?>
  <td><a href="combination_1_answer_sheet.php?edit_answer_id=<?php echo $row_b['ans_id']; ?>"> Edit</a></td>
  <td><a href="combination_1_answer_sheet.php?delete_answer_id=<?php echo $row_b['ans_id']; ?>"> Delete</a></td>
  <?php } ?>
</tr>
<?php	
}	
