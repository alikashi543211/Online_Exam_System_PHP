...
<a href="comb_2_obj_print_paper.php?printer=set">Print Paper</a>
<?php } */ ?>
...
<?php
for($mix=1;$mix<=2;$mix++)
    {     //START OF LOOP  1 FOR MCQS AND 2 FOR TRUE FALSE.
?>
...
<?php
    if($mix==1)
    {
     ...
     <tr style="text-align:center;font-weight:bold;">	 
	  ...
	  <tr>
	  <?php if(!isset($mix2)) { ?>
	  <td align="right" style='font-weight:bold;'><?php  echo "Objective Marks (".$_SESSION['t_marks_mcq']."+".$_SESSION['t_marks_tf']."=".$_SESSION['total_marks'].")"; ?></td>
	  <?php } ?>
	  <?php if(isset($mix2)) { ?>
	  <td align="right" style='font-weight:bold;'><?php  echo "Objective Marks (".$_SESSION['t_marks_mcq']."+".$_SESSION['t_marks_tf']."=".$_SESSION['total_marks1'].")"; ?></td>
	  <?php } ?>
	</tr>
	</table>
	<?php
...
//_______________________ /Header Question ___________________________-->
...
?>			  
				  ...
				  <tr>
                                   <td border="5" colspan="2" align="right" class="print_btn2">
		                                          <a href="combination_2.php">Edit Questions</a>
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                                               <a href="comb_2_obj_print_paper.php?edit_ans=<?php echo "yes"; ?>">Edit Answers</a>
								     </td> 
                   </tr>
				  <?php } ?>
