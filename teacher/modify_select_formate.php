...
{
	 $_SESSION['submit']="You are in Formate Creating Mode.";
...
if(isset($_POST['next3']))
{
  ...
  unset($_SESSION['step2']);
  unset($_SESSION['step3']);
  $_SESSION['final']="Formate Has Been Created Successfully..";
}
if(isset($_SESSION['final']))
{
echo "<h1 align='center'>".$_SESSION['final']."</h1>";
}
...
<tr>
<td><input style="cursor:pointer;width:150px;height:50px;background-color:lightgrey;color:black;" type="submit" name="objective" value="Objective (Paper)" /></td>
<td><input style="cursor:pointer;width:150px;height:50px;background-color:lightgrey;color:black;" type="submit" name="subjective" value="Subjective (Paper)" /></td>
<td><input style="cursor:pointer;width:150px;height:50px;background-color:lightgrey;color:black;" type="submit" name="mix" value="Mix (Paper)" /></td>
</tr>
</table>
</form>
...
if(isset($_POST['change_formate1']))
{
	unset($_SESSION['submit']);
	unset($_SESSION['step1']);
	unset($_SESSION['step2']);
...
<!---------------------------------------------------TOTAL MARKS INTERFACE------------------------------------------------>
	...
	<td colspan="2" align="right" >
				 ...
				 <?php 
				                    //check total marks and display check after send
				 if (isset($false))         { echo "<span style='color:white;'>".$false."</span>"; }					
			else if (isset($check4))         { echo "<span style='color:white;'>".$check4."</span>"; }
...
<!--------------------------------------------------MCQS INTERFACE----------------------------------------------------------->
   ...
   <?php //if(!isset($choice1_unset)) 
	   if(!isset($_SESSION['submit']) || isset($_SESSION['step1']))
	   {
   {  
	   ?>	
	...
	<?php
	   } // row not display on submit button
	   else if(isset($_SESSION['submit'])) 
	   {
		   ?>
		   <tr>
		   <td align="center" colspan="2" style="color:white;"><h1>MCQs</h1></td>
		   </tr>
		   <?php
	   }
	   ?>
...
<?php  
	...
	<td colspan="2">
				 ...
				 <tr>
				     <td colspan="2" align="right"><input type="submit" name="next1" value="Next" /></td>
				 </tr>
	       </table>
...
<!------------------------------------------------FILL IN BLANKS INTERFACE--------------------------------------------------->
	...
	<?php  //if(!isset($choice2_unset))
   if(!isset($_SESSION['submit']) || isset($_SESSION['step2']))
   {
 {  
	   ?>
	   <?php if(!isset($_SESSION['submit'])) { ?>
	...
	name="m1_choice2" <?php } ?> value="Fill In Blanks" 
	   ...
	   else if(isset($_SESSION['submit']))
	   {
		   ?>
		   <tr>
		   <td align="center" colspan="2" style="color:white;"><h1>Fill in Blanks</h1></td>
		   </tr>
		   <?php
	   }
   }
	...
	<td colspan="2">                                        <!--Formate Of Fill_In_Blanks Interface-->
	        ...
	        <table style="color:white;font-size:20px;">
	            ...
	            <tr>
				 ...
				 <tr>
				     <td colspan="2" align="right"><input type="submit" name="next2" value="Next" /></td>
				 </tr>
	       </table>
...
<!--------------------------------------------------TRUE_FALSE INTERFACE----------------------------------------------------->
	<?php //if(!isset($choice3_unset))
    if(!isset($_SESSION['submit']) || isset($_SESSION['step3']))
	{
   {  
	   ?>
	   <?php if(!isset($_SESSION['submit'])) { ?>
	...
	name="m1_choice3" <?php } ?> value="True False Statements" 
	   ...
	   else if(isset($_SESSION['submit']))
	   {
		   ?>
		   <tr>
		   <td align="center" colspan="2" style="color:white;"><h1>True False</h1></td>
		   </tr>
		   <?php
	   }
   }  
...
<!--------------------------------------------------TRUE_FALSE FORMATE INTERFACE--------------------------------------------->													   
				 ...
				 <tr>
				     <td colspan="2" align="right"><input type="submit" name="next3" value="Next" /></td>
				 </tr>
				      </table>
<!--------------------------------------------------/TRUE_FALSE FORMATE INTERFACE--------------------------------------------->			 
...
<?php if(!isset($_POST['mix']) && !isset($_POST['submission']) && !isset($_POST['mix_send_formate']))           //when mix set then submit button not displayed
	...
	<tr>
	     <td colspan="2" align="right">
		                        ...
		                        <input style="cursor:pointer;height:30px;background-color:darkgrey;" type="submit" name="<?php echo $btn1_name;   ?>"    
	     ...
	     <td style="float:right;" colspan="2" align="left">
		         <form method="post">         
		                        <br><input style="cursor:pointer;height:30px;background-color:darkgrey;" type="submit" name="change_formate1"    
...
<!------------------------------------------------------TOTAL MARKS INTERFACE------------------------------------------------>
	...
	<td colspan="2" align="right" >
				 ...
				 <?php 
				  ...
				  if (isset($false))         { echo "<span style='color:white;'>".$false."</span>"; }	//Message of Error Total Check in Mix				
				else  if (isset($check))         { echo "<span style='color:white;'>".$check."</span>"; }
...
<!-------------------------------------------------------BUTTON INTERFACE---------------------------------------------------->		
	...
	<tr>
	     <td colspan="2" align="right">
		                        <input style="cursor:pointer;height:30px;background-color:darkgrey;" type="submit" name="<?php echo $btn2_name;   ?>"    
	     ...
	     <td style="float:left;" colspan="2" align="left">
		                  <form method="post">
		                        <br><input style="cursor:pointer;height:30px;background-color:darkgrey;" type="submit" name="change_formate2"    
	                                  value="Change Formate"     />                  <!--Button 2 -->
...
if(isset($_POST['mix']) || isset($_POST['submission']) || isset($_POST['mix_send_formate']))
{
	...
	<tr>
	     <td colspan="2" align="right">
		                        <input style="cursor:pointer;width:120px;height:30px;background-color:darkgrey;" type="submit" name="<?php echo $b_name1; ?>"    
	     ...
	     <td style="float:left;" colspan="2" align="left">
		                  <form method="post">
		                        <br><input style="cursor:pointer;height:30px;width:120px;background-color:darkgrey;" type="submit" name="mix_change_formate"    
	                                  value="Change Formate"     />                  <!--Button 2 -->
