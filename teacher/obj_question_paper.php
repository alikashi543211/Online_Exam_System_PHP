...
if(!isset($_SESSION['done1']) && !isset($_SESSION['done']))
{
	                ...
	                <td><?php  echo "Question".$question_number++.":"; ?> &nbsp;&nbsp;&nbsp;&nbsp; </td> <?php // Question Numbering...?>
	                 <td><input style="padding:5px;border:none;height:30px;width:1050px;" type="text" name="question_discription[]" required /></td>     <?php //Question Discription... ?>
					  ...
					  <?php  echo "(".$marks_of_each.")"; ?>
					   ...
					   <td><select select style="height:30px;border:none;" name="status" >
...
<!--___________________Button_____________________--> 
 <tr>
  <td align="center">
  <?php?>
	<br><br><br><input style="border:none;height:50px;width:100px;background-color:navy;color:white;cursor:pointer;" type="submit" name="done" value="Next" />
    </td>
   </tr>
...
<?php /* if(isset($_SESSION['done1']) && !isset($_SESSION['done']) && !isset($_SESSION['ready_edit_mode']) && !isset($_SESSION['save_paper'])) */
if(isset($_SESSION['done1']))
	{ 
?>
<center>
<form method="post">
<input style="height:50px;border:none;width:150px;background-color:navy;color:white;cursor:pointer;" type="submit" name="set_ans" value="Set Answers" />
</form></center>
...
if(isset($_POST['display_paper'])) // display paper work at display paper button.
{
	...
	else if(isset($_SESSION['section_back2']) || isset($_SESSION['one_one']) || isset($_SESSION['one_1']))
	{
		header ("Location:single_obj_sub_print.php");
	}
	else 
...
if(isset($_POST['go_to']))
{
	...
	else if(isset($_SESSION['section_back2']) || isset($_SESSION['one_1']))
	 {
...
<?php
//$_SESSION['refresh']="a";
if(isset($_SESSION['ready_edit_mode']) && !isset($_SESSION['refresh'])  && !isset($_SESSION['edit_update']))
{
	?>
	<center><form method="post" align="center">
	


	
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;"
<?php if (isset($_SESSION['edit_update'])) { ?> disabled <?php } ?>  type="submit" name="obj_type" value="<?php echo $obj_type; ?> ( Questions )" />
<?php
?>
...
<?php  ?>
<?php if(isset($_SESSION['section_back2']) || isset($_SESSION['one_one']) || isset($_SESSION['one_1'])) { ?>
	
	<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="go_to" value="Go To Subjective" />
