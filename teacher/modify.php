...
{
	$_SESSION['obj_type']="Objective Questions Are Displayed Successfully.";
}
...
<h1 style="color:green;" align="center">Input 'MCQs' Questions</h1>
<?php
	}
?>
<?php 
	 ...
	 {
		 ?>
<h1 style="color:green;" align="center">Input 'Fill in Blanks' Questions</h1>
<?php
	     }
?>
<?php
if(isset($_SESSION['objective_type']) && $_SESSION['objective_type']=='True False')
	 {
?>
<h1 style="color:green;" align="center">Input 'True False' Questions</h1>
<?php
	      }
?>
...
<!--___________________Button_____________________--> 
 <tr>
  <td align="center">
  <?php?>
	<input style="cursor:pointer;width:150px;height:50px;background-color:lightgrey;color:black;" type="submit" name="done" value="Next" />
    </td>
   </tr>
...
<form align="center" method="post">
<input style="cursor:pointer;width:150px;height:50px;background-color:lightgrey;color:black;" type="submit" name="set_ans" value="Set Answers" />
</form>
...
<input style="cursor:pointer;width:250px;height:50px;color:black;border-radius:4px;" type="submit" name="obj_type" value="Edit Questions<?php echo " ( ".$obj_type." )"; ?>" />
<?php
?>
...
<?php  ?>
<?php //if(isset($_SESSION['answers_set']) || isset($_SESSION['edit_paper']))  ?>
<input style="cursor:pointer;width:250px;height:50px;color:black;border-radius:4px;" type="submit" name="display_paper" value="Display Paper <?php echo " ( ".$obj_type." )"; ?>" />
<?php  ?>
...
<?php
	...
	{
	?>
<h1 align="center" style="color:green;">Questions ( Database )</h1>
