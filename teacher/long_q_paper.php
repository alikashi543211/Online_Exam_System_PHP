...
// ________________________________________Setting Of Total Marks_______________________________________________
...
{
	 $total_marks=$_SESSION['t_marks_lq'];
}
...
if(isset($_GET['disp_paper']))
{
	...
	if(isset($_SESSION['set_btn2']) || isset($_SESSION['two_s']) || isset($_SESSION['two_ss'])
		|| isset($_SESSION['two_sss'])	|| isset($_SESSION['double_1']) || isset($_SESSION['double_2'])
      	|| isset($_SESSION['double_3']))
	{
		header ('Location:comb_obj_sub_print.php');
	}
	else if(isset($_SESSION['set_btn1']))
	{
		header ('Location:single_obj_sub_print.php');
	}
	else if(isset($_SESSION['paper1']) || isset($_SESSION['one_1']))
	{
		header ("Location:single_obj_sub_print.php");
	}
...
if(isset($_GET['go_ob']))
{
   ...
   if(isset($_SESSION['two_s']) || isset($_SESSION['double_1']))
   {
	   header ("Location:combination_1.php");
   }
   else if(isset($_SESSION['two_ss']) || isset($_SESSION['double_2']))
   {
	   header ("Location:combination_2.php");
   }
   else if(isset($_SESSION['two_sss']) || isset($_SESSION['double_3']))
   {
	   header ("Location:combination_3.php");
   }
}
if(isset($_GET['mov_obj']))
{
...
// ------------------------------------------------ Go To Short Questions -----------------------------------------------------
if(isset($_GET['short_q']))
{
	$_SESSION['show_q']="Set";
...
if(isset($_POST['done']) && $calculate_total==$total_marks)
	{
		...
		if(!isset($mix))
		{
			$_SESSION['done']="Paper Created Successfully.";
		}
		...
		else if(isset($mix) && isset($_SESSION['comb_s']) && (isset($_SESSION['comb1']) || isset($_SESSION['comb2']) || isset($_SESSION['comb3'])))
		{
			...
			if(isset($_SESSION['comb1']))
			{
			$_SESSION['double_1']="Set";
			}
			else if(isset($_SESSION['comb2']))
			{
			$_SESSION['double_2']="Set";
			}
			else if(isset($_SESSION['comb3']))
			{
			$_SESSION['double_3']="Set";
			}
				//header ("Location:comb_obj_sub_print.php");
		}	
		...
		else if(isset($mix) && isset($_SESSION['one_sub']) && isset($_SESSION['section2']))		
		{
			$_SESSION['done']="Set";
			$_SESSION['mix_11']="Set";
			header ("Location:long_q_paper.php");
...
<h2 align="left" style="font-size:35px;color:purple;text-align:center">Subjective Paper (<span style="font-size:25px;"> <?php echo "Long Questions"; ?> </span>) </h2>
...
<?php if(isset($_POST['question_discription'])) { ?> value="<?php echo $_POST['question_discription'][$q++]; ?>" <?php } ?>					 required /></td>     <?php //Question Discription... ?>
					  ...
					  <?php if(!isset($_POST['marks'])) { ?>placeholder="Marks" <?php } ?>
<?php if(isset($_POST['marks'])) { ?> value="<?php echo $_POST['marks'][$m++]; ?>" <?php } ?>					  required />
...
<center>
<form method="get">
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="disp_ques" value="Show Questions ( Long )" /> 
<?php if(isset($_SESSION['paper1'])) { ?>
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="short_q" value="Show Questions ( Short )" />
...
<?php } ?>
<?php if(isset($_SESSION['double_1']) || isset($_SESSION['double_2']) || isset($_SESSION['double_3'])) { ?>
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="short_q" value="Show Questions ( Short )" />
<?php } ?>
<?php if(isset($_SESSION['one_1'])) { ?>
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="go_to" value="Go To Objective" />
<?php } ?>
<?php if(isset($_SESSION['two_s']) || isset($_SESSION['two_ss']) || isset($_SESSION['two_sss'])
	|| isset($_SESSION['double_1']) || isset($_SESSION['double_2']) || isset($_SESSION['double_3'])) { ?>
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="go_ob" value="Go To Objective" />
<?php } ?>
<?php if(isset($_SESSION['mix_11'])) { ?>
<input style="border-radius:4px;border:none;height:50px;width:200px;background-color:navy;color:white;cursor:pointer;" type="submit" name="mov_obj" value="Go To Objective" />
<?php } ?>
