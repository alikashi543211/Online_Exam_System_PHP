...
session_start();
 ...
 {  
      ...
      $sql = "SELECT question_id,question,q_paper_id FROM question WHERE  q_paper_id='$q_paper_id' ";  
      ...
      $output .= '<tr>  
                          ...
                          ';
    	$sql2 = "SELECT ans,option_name,question_id FROM answers WHERE  question_id='$question_id'  ";  					  
